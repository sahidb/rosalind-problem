...
the positions of all occurrences of 'U' in "AUGCUUCAGAAAGGUCUUACG" are 2, 5, 6, 15, 17, and 18). The symbol at position i
...
for example, if s = "AUGCUUCAGAAAGGUCUUACG", then s[2:5]
...
string = open("dataset/rosalind_subs.txt").read()
s,t = string.split()
for i in match(s,t):
    print(i, end =' ')